					...
					<div class="box-list-body">
						<div class="detail-thread thread">
							...
							<div class="detail-desc col-sm-8">
								...
								<div class="by-thread"><i class="c-down fa fa-chevron-down"></i> </div>
										<div class="rate-thread" data-toggle="modal" title="Rate this" data-target=".rate-bs-example-modal-lg">
										<?php
											...
											if($rating){
												...
												echo "<a href='#' class='fa fa-star'>No rate</a>";
											}
										?>
										</div>
								<br /><br />
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="post-comm col-sm-12">
						...
						<form class="post-form" role="form" action="/bisiq/threadreports/add/<?php echo $replythread['Replythread']['id']; ?>/<?php echo $thread['Thread']['id']; ?>" method="post">
							...
							<textarea name="data[Threadreport][reason]" class="form-control"></textarea>
				...
				<div class="clear"></div>
					...
					<div class="post box-list-body">
						<div class="post-comm col-sm-12">
							...
							<?php echo $this->Form->create('Replythread', array('action' => '/add/'.$idt));?>
								<div class="form-group">
									<?php
