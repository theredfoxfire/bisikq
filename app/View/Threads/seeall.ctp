		...
		<div class="main-content">
			<div class="container">
				<div class="box-list col-sm-12">
					...
					<?php 
						foreach ($all as $cat): 
						if($cat['Category']['id'] === $catid){
					?>
						<div class="box-list-head-title">
							<div class="p-first"><?php echo $this->Html->link($cat['Category']['name'], array('controller' => 'threads', 'action' => 'seeall', $cat['Category']['id'] )); ?></div>
						</div>
					<?php
						} else {
					?>
							<div class="box-list-head-title">
								<div class="p-head"><?php echo $this->Html->link($cat['Category']['name'], array('controller' => 'threads', 'action' => 'seeall', $cat['Category']['id'] )); ?></div>
							</div>
					<?php
						}
						endforeach;
