				  ...
				  <div class="container-fluid">
					...
					<div class="navbar-collapse collapse">
					  <ul class="nav navbar-nav navbar-right">
						...
						<li><?php echo $this->Html->link("<i class='glyphicon glyphicon-off'></i> Logout", array('controller'=>'admins', 'action' => 'logout'), array('escape' => false)); ?></li>
						<li class="h-menu"><?php echo $this->Html->link("<i class='glyphicon glyphicon-list-alt'></i> Threads", array('controller'=>'threads', 'action' => 'index'), array('escape' => false)); ?></li>
						<li class="h-menu"><?php echo $this->Html->link("<i class='glyphicon glyphicon-briefcase'></i> Categories", array('controller'=>'categories', 'action' => 'adminindex'), array('escape' => false)); ?></li>
						<li class="h-menu"><?php echo $this->Html->link("<i class='glyphicon glyphicon-link'></i> Reply Threads", array('controller'=>'replythreads', 'action' => 'index'), array('escape' => false)); ?></li>
